...
import RatingDroprown from "@/components/RatingDropdown";
...
export const LectureList = [
  {
    ...
    description:
      "Nguyễn Văn A có kinh nghiệm giảng dạy lập trình Python hơn 5 năm.",
    workAt: "MindX Hà Nội",
  ...
  },
  {
    ...
    description:
      "Trần Thị B là chuyên gia trong phát triển các ứng dụng web hiện đại.",
    workAt: "MindX Hà Nội",
  ...
  },
  {
    ...
    description:
      "Phạm Văn C chuyên sâu trong lĩnh vực khoa học dữ liệu và trí tuệ nhân tạo.",
    workAt: "MindX Hà Nội",
  ...
  },
  {
    ...
    description:
      "Lê Thị D có nhiều năm kinh nghiệm trong lĩnh vực an ninh mạng.",
    workAt: "MindX Hà Nội",
  ...
  },
  {
    ...
    description:
      "Vũ Văn E là chuyên gia với hơn 10 năm kinh nghiệm lập trình Java.",
    workAt: "MindX Hà Nội",
    levelOfEducation: "Cử nhân Kỹ thuật Phần mềm",
    facebook: "https://facebook.com/vuvane",
    quoteOfLife:
      "Mọi vấn đề đều có giải pháp, hãy bắt đầu từ việc đơn giản nhất.",
  },
  {
    id: 6,
    name: "Ngô Thị F",
    ...
    description:
      "Ngô Thị F là chuyên gia về phát triển ứng dụng di động Android.",
    workAt: "MindX Hà Nội",
  ...
  },
  {
    ...
    description:
      "Đặng Văn G có kinh nghiệm trong thiết kế hệ thống nhúng và kỹ thuật máy tính.",
    workAt: "MindX Hà Nội",
  ...
  },
  {
    ...
    description:
      "Hoàng Thị H chuyên gia trong phân tích và thiết kế các hệ thống thông tin doanh nghiệp.",
    workAt: "MindX Hà Nội",
  ...
  },
  {
    ...
    description:
      "Đỗ Thị K có nhiều năm kinh nghiệm nghiên cứu và giảng dạy về trí tuệ nhân tạo và máy học.",
    workAt: "MindX Hà Nội",
...
const Lecturers: React.FC = () => {
  ...
  const [debouncedValue, setDeboundcedValue] = useState("");

  const handleButton = () => {
    setTimeout(() => {
      setDeboundcedValue(searchValue);
    }, 500);
  };
  ...
  return (
    <>
      ...
      <div className="box ml-auto mr-auto mt-20 mb-48 pb-6 w-11/12">
          ...
          <div className="searchbar flex items-center">
            <Space.Compact style={{ width: "100%" }}>
              ...
              <Button
                ...
                style={{ backgroundColor: " #bb0409" }}
              >
                Submit
              </Button>
            </Space.Compact>
            {/* <button className="searchBtn ml-3 p-3 text-2xl ">Tìm kiếm</button> */}
          </div>
          <div className="dropdown flex items-center justify-center gap-4">
            <RatingDroprown />
            <CourseDropdown />
          </div>
        </div>
        {loading && <p className="mx-auto w-fit">Loading...</p>}
      ...
      <UserContext.Provider value={lecturers}></UserContext.Provider>
    </>
  );
};
