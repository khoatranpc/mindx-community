    ...
    [
        {
            ...
            description: "Chịu trách nhiệm kết nối, hỗ trợ học viên với doanh nghiệp, giảng viên",
        },
        {
            icon: Business,
            title: "Doanh nghiệp",
    ...
    [
        {
            icon: Programmer,
            title: "Giảng viên",
            description: "Giảng viên là những người có kinh nghiệm lâu năm trong ngành, sở hữu nghiệp vụ giáo dục",
        },
        {
            icon: Student,
            title: "Học viên",
            ...
            <div className="banner p-[5.6rem]">
                <div className="row flex items-center gap-[2.4rem]">
                    <div className="des w-[60%]">
                        ...
                        <p className="text-[2.8rem]  mb-[1.2rem]">
                            ...
                            <span>
                                <Typewriter
                                    options={{
                                        strings: ['Giao lưu', 'Hướng Nghiệp', 'Chia sẻ kinh nghiệm', 'Kết nối Giảng viên, Doanh nghiệp'],
                                        autoStart: true,
                                        delay: 0.1,
                                        loop: true,
                                        deleteSpeed: 0,
                        ...
                        <p className="text-[var(--bs-color)] text-[1.8rem] mb-[2.4rem]">Xuất phát từ nhu cầu kết nối, học hỏi từ học viên của MindX, nền tảng được xây dựng với mục tiêu là cánh cổng giúp học viên, doanh nghiệp, giảng viên có thể kết nối, chia sẻ với nhau</p>
                        <h2 className="text-[2.8rem] font-bold mb-[2.4rem] text-[var(--base)]">Người dùng</h2>
                    ...
                    <div className="img w-[40%] relative">
                        <img className="max-w-full rounded-[10px]" src="/cutBanner.png" alt="" />
                        <div className="absolute bottom-[4.2rem] left-0 translate-x-[-50%] rounded-[12px] groupUser py-[1.2rem] px-[2.4rem]">
                            ...
                            >
                                ...
                                <Avatar style={{ backgroundColor: '#ffbf00' }}><span className="text-[1.4rem] font-bold">+400</span></Avatar>
                            </Avatar.Group>
